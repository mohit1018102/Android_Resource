...
1. **How to reformat source code**  *code> reformat code* -> selected text **to reformat the code: fix the spacing and tabs.**
2. **How to rearrange source code** *code>rearrange code*-> selected text **order the attribute according to the android studio guidelines.**
